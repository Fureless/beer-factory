...
export const Profile = () => {
    ...
    // SELECT * FROM Customer WHERE IdUser=@idUser
    // ВЫВОДИМ ПОЛУЧЕНЫЕ ДАННЫЕ В PLACEHOLDER
    // ВВОДИМ НОВЫЕ ДАННЫЕ В ПОЛЯ
    // ПО НАЖАТИЮ КНОПКИ ДЕЛАЕМ ЗАПРОСЫ ПОДРЯД НА ИЗМЕНЕНИЕ ВСЕХ ПОЛЕЙ
    // ВЫВОДИМ СООБЩЕНИЕ ОБ УСПЕХЕ/ПРОВАЛЕ
    ...
    //                                className="profile-input validate" value={form.firstName} onChange={changeHandler}/>
    //                         <label htmlFor="first_name">First Name</label>
    //                     </div>
    //                     <div className="input-field col s6">
    //                         <input id="last_name" type="text" name="lastName" placeholder="surname"
    //                                className="profile-input validate" value={form.lastName} onChange={changeHandler}/>
    ...
    //                                className="profile-input validate" value={form.date} onChange={changeHandler}/>
